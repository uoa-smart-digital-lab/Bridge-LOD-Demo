/**********************************************************************************************************************************************************
 * XRUX_SliderSwitch_Sizer
 * -----------------------
 *
 * 2021-11-24
 *
 * Editor Layer Settings for XRUX_SliderSwitch_Sizer
 *
...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------
[CustomEditor(typeof(XRUX_SliderSwitch_Sizer))]
public class XRUX_SliderSwitch_Sizer_Editor : Editor
{
    // ------------------------------------------------------------------------------------------------------------------------------------------------------
    // Variables
    // ------------------------------------------------------------------------------------------------------------------------------------------------------
    float width, height, thickness;      // The dimensions of the object to be used by the editor
    XRUX_SliderSwitch_Sizer mainTarget;
    ...
    {
        mainTarget = (XRUX_SliderSwitch_Sizer)target;
